      ...
      <div className="flex flex-col justify-center items-center px-8 md:px-16 lg:px-24">
        <div className="w-full max-w-104 flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-4 mt-2">
            ...
            <button className="text-left inline-block text-sm underline-offset-4 hover:underline cursor:pointer">
              Forgot password?
            </button>
          </div>

          <Button className="w-full h-9 mt-2 bg-[#000000] hover:bg-[#494949] text-white font-medium rounded-lg transition-colors">
            Let&apos;s Go
          </Button>
