...
import AddCategoryDialog from "../_features/dish-form-dialog";
...
export default function CategoryChips({
  ...
  return (
    <div className="w-full min-h-44 flex flex-col px-6 py-6 gap-4 rounded-xl bg-white border border-gray-100 shadow-sm">
